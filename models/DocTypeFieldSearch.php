...
/**
 * DocTypeFieldSearch represents the model behind the search form of `app\models\DocTypeField`.
 */
class DocTypeFieldSearch extends DocTypeField
{
    /**
     * {@inheritdoc}
     */
